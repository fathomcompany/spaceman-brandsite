  ...
  /******/ [
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_stylus_loader_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
        _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_stylus_loader_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0__
      )
      /* unused harmony reexport * */
      /* unused harmony default export */ var _unused_webpack_default_export =
        _node_modules_mini_css_extract_plugin_dist_loader_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_stylus_loader_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0___default.a
...
*/
      ...
      function loading_coffee_typeof(obj) {
        if (
          typeof Symbol === 'function' &&
          typeof Symbol.iterator === 'symbol'
        ) {
          loading_coffee_typeof = function _typeof(obj) {
            return typeof obj
          }
        } else {
          loading_coffee_typeof = function _typeof(obj) {
        ...
        return loading_coffee_typeof(obj)
      }
...
*/
      ...
      /* harmony default export */ var loading_coffee = {
        ...
        mounted: function mounted() {
          ...
          return ['poster', 'image', 'video', 'fallback'].forEach(function(
            asset
          ) {
            return _this.$watch(
              asset + 'ShouldLoad',
        ...
        computed: {
          ...
          videoShouldLoad: function videoShouldLoad() {
            switch (false) {
              ...
              case !(
                (this.poster && !this.posterLoaded) ||
                (this.image && !this.imageLoaded)
              ):
                return false
        ...
        methods: {
          ...
          loadImgAsset: function loadImgAsset(asset) {
            ...
            this[asset + 'Loader'].addEventListener(
              'load',
          ...
          removeImgAssetLoader: function removeImgAssetLoader(asset) {
            if (this[asset + 'Loader'] && this[asset + 'OnLoad']) {
              return this[asset + 'Loader'].removeEventListener(
                'load',
                this[asset + 'OnLoad']
              )
            }
          ...
          loadVideoAsset: function loadVideoAsset() {
            ...
            this.$refs.video.addEventListener(
              'loadedmetadata',
              (this.videoOnLoadedmetadata = function() {
                if (_this4.$refs.video) {
                  // Check that Visual hasn't been removed since started
      ...
      var external_is_numeric_default = /*#__PURE__*/ __webpack_require__.n(
        external_is_numeric_
      )

      // CONCATENATED MODULE: ./src/size.coffee
      function size_coffee_typeof(obj) {
        if (
          typeof Symbol === 'function' &&
          typeof Symbol.iterator === 'symbol'
        ) {
          size_coffee_typeof = function _typeof(obj) {
            return typeof obj
          }
        } else {
          size_coffee_typeof = function _typeof(obj) {
        ...
        computed: {
          ...
          containerClasses: function containerClasses() {
            return {
              ...
              // Centering
              'vv-align-left':
                this.align.indexOf('left') !== -1 && this.filledSlot,
              'vv-align-center':
                this.align.indexOf('center') !== -1 && this.filledSlot,
              'vv-align-right':
                this.align.indexOf('right') !== -1 && this.filledSlot
            }
          },
          // Asset classes
          ...
          slotClasses: function slotClasses() {
            return {
              'vv-align-bottom':
                this.align.indexOf('bottom') !== -1 && this.filledSlot,
              'vv-align-middle':
                this.align.indexOf('middle') !== -1 && this.filledSlot,
              'vv-align-top':
                this.align.indexOf('top') !== -1 && this.filledSlot
            }
          },
          // Shim classes
          ...
          hasVerticalAlign: function hasVerticalAlign() {
            return (
              this.align.indexOf('bottom') ||
              this.align.indexOf('middle') ||
              this.align.indexOf('top')
            )
          }
        },
        //#############################################################################
      ...
      /* harmony default export */ var transition_coffee = {
        ...
        computed: {
          ...
          posterShouldRender: function posterShouldRender() {
            switch (false) {
              case !(
                (this.imageShouldRender && this.imageLoaded) ||
                (this.videoShouldRender && this.videoLoaded) ||
                (this.fallbackShouldRender && this.fallbackLoaded)
              ):
                return false
...
*/
      ...
      canPlay = function canPlay(url) {
        ...
        return !!(video != null
          ? typeof video.canPlayType === 'function'
            ? video.canPlayType(_mime(url)).replace('no', '')
            : void 0
          : void 0)
      ...
      /* harmony default export */ var video_coffee = {
        ...
        computed: {
          ...
          canAutoplayVideo: function canAutoplayVideo() {
            switch (false) {
              case !(typeof navigator !== 'undefined' && navigator !== null
              ...
              case !(
                (typeof navigator !== 'undefined' && navigator !== null
                  ? navigator.userAgent.match(/(iPhone|iPod)/gi)
                  : void 0) &&
        ...
        watch: {
          ...
          playing: function playing() {
            ...
            if (this.playing) {
              return (ref = this.$refs.video.play()) != null
                ? ref.catch(function(e) {
      ...
      var external_vue_in_viewport_mixin_default = /*#__PURE__*/ __webpack_require__.n(
        external_vue_in_viewport_mixin_
      )
      ...
      /* harmony default export */ var viewport_coffee = {
        ...
        props: {
            ...
            default: function _default() {
              ...
              for (i = 0, len = ref.length; i < len; i++) {
                ...
                switch (false) {
                  ...
                  case ((ref1 = this['load'.concat(ucfirst_coffee(asset))]) !=
                  null
                    ? ref1
                    : this.load) !== 'visible':
                    return true
          ...
          inViewportOnce: {
            ...
            default: function _default() {
              if (this.video) {
                return (
                  'visible' !== this.autoplay && 'visible' !== this.autopause
                )
              } else {
                return true
              }
        ...
        mounted: function mounted() {
          ...
          if (this.shouldWatchComponentSize) {
            ...
            return (this.handleWindowResizeThrottled = throttle_default()(
              this.handleWindowResize,
              100
            ))
          }
